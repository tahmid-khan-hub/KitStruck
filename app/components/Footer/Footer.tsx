...
const Footer = () => {
  ...
  return (
    <footer className="bg-white text-black border-t border-t-gray-300">
      <div className="max-w-[1350px] w-[96%] mx-auto px-4 md:px-3 py-8 md:flex md:items-center md:justify-between">
        ...
        <div className="flex flex-col">
          <h4 className="mb-1.5 text-gray-800 font-semibold">Follow us </h4>
          ...
          <a
            href={"https://x.com"}
            target="_blank"
            className="hover:text-sky-400 text-gray-700"
          >
            <svg fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24">
